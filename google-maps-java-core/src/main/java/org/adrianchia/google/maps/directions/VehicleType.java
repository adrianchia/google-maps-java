...
public final class VehicleType {
    ...
    /**
     * Share taxi is a kind of bus with the ability to drop off and 
     * pick up passengers anywhere on its route. 
     */
     ...
     * A Funicular typically consists of two cars, 
     * with each car acting as a counterweight for the other. 
     */
